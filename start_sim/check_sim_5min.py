"""
Script that checks that replica exchange simulations ran to completion. Only checks simulations at 5 min.
...
times=['5min_v3_s7g2']
N_sims={'5min_v3_s7g2':19}
#times=['5min_v2_s7g2','5min_v2_m2s7g2','5min_v2_m5s7g2']
#N_sims={'5min_v2_s7g2':19,'5min_v2_m2s7g2':19,'5min_v2_m5s7g2':19}
...
for i in range(0, len(times)):
    ...
    for k in range(0, len(results)):
        ...
        for j in range(0,N_states):
            ...
            #os.chdir(time_dir)
            state_dir=time_dir+'/'+str(index)+'_5min'
            os.chdir(state_dir)
            log_file = str(index) + '_5min_0.log'
