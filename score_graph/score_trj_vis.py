"""
Script to recreate the full spatiotemporal model, and write a more visually appealing directed acyclic graph.
...
output_dir3=input_dir+'total_vis/'
...
nodes3,graph3,graph_prob3,graph_scores3=spatiotemporal.create_DAG(dict,scorestr='_scores_tot.log',npaths=6,input_dir=input_dir,output_dir=output_dir3,spatio_temporal_rule=True,expected_subcomplexes=subcomplexes,score_comp=True,exp_comp_map=exp_comp,draw_dag=False)
write_output.draw_dag('dag_heatmap',nodes3,graph3,graph_prob3,dict.keys(),colormap='coolwarm',draw_label=False,penscale = 4.8,arrowsize = 9.6,height = '2.4',width = '2.4')
