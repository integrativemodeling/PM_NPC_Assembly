"""Script that calculates the violations in Nups excluded volume with the membrane.
...
# Returns number of violations and the number of violations per leaf
...
np.savetxt('EV_viol_membrane_1500.txt',EV_viol)
np.savetxt('EV_viol_norm_membrane_1500.txt',EV_viol_norm)
